-- Replace the skip mechanic with fail: when a revealing team fails a
-- challenge, the challenge goes back to open for everyone else, but the
-- failing team is locked out from retrying it.

alter table public.challenges
  add column failed_team_ids uuid[] not null default '{}'::uuid[];

drop function if exists public.skip_challenge(uuid);

-- ============================================================
-- fail_challenge — failing team gives up; recorded in failed_team_ids
-- ============================================================
...
-- ============================================================
-- reveal_challenge — block teams that have already failed this challenge
-- ============================================================
