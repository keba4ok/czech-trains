-- Game timer / pause / end.
--
-- New column `paused_at` records when the admin paused the game. On resume,
-- the time spent paused is added to `ends_at` so the countdown effectively
-- freezes during a pause.
--
-- Also tighten the challenge RPCs so a revealed challenge can't be completed
-- or failed while the game is paused or ended.

alter table public.games
  add column paused_at timestamptz;

-- Publish the games table so clients can react to status/ends_at changes in real time.
alter publication supabase_realtime add table public.games;

-- ============================================================
-- complete_challenge — require active status
-- ============================================================
...
-- ============================================================
-- fail_challenge — require active status
-- ============================================================
